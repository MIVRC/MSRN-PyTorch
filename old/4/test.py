...
parser.add_argument("--model", default="final_x4.pth", type=str, help="model path")
parser.add_argument("--imagepath", default="../../PSNR_test/4/set5_x4", type=str, help="image path")
