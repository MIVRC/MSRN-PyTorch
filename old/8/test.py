...
parser.add_argument("--model", default="final_x8.pth", type=str, help="model path")
parser.add_argument("--imagepath", default="../../PSNR_test/8/set5_x8", type=str, help="image path")
parser.add_argument("--scale", default=8, type=int, help="")
